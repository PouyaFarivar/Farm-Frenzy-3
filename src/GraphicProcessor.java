...
public class GraphicProcessor
{
    ...
    public Group play (User user , Level level) throws FileNotFoundException
    {
        ...
        build.setLayoutX(350);
        build.setLayoutY(0);
        build.setPrefSize(70, 35);
        Button upgrade = new Button("Upgrade");
        upgrade.setLayoutX(350);
        upgrade.setLayoutY(35);
        upgrade.setPrefSize(70, 35);
